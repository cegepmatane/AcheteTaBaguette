...
-- maj 8
ALTER TABLE PRODUIT CHANGE idCategorie categorie INT(4) NOT NULL;
ALTER TABLE CATEGORIE CHANGE idCategorie idCategorie INT(4) NOT NULL AUTO_INCREMENT;

-- facture
ALTER TABLE FACTURER CHANGE idFacture facture INT(4) NOT NULL;
ALTER TABLE FACTURE DROP FOREIGN KEY FACTURE_ibfk_1;
ALTER TABLE FACTURE DROP idProduit, DROP nbProduit;
ALTER TABLE FACTURE ADD prixHT FLOAT(4) NOT NULL DEFAULT '0' AFTER dateAchat, ADD prixTTC FLOAT(4) NOT NULL DEFAULT '0' AFTER prixHT;
CREATE TABLE LISTE_PRODUIT_FACTURE (
	produit int(4) NOT NULL,
	facture int(4) NOT NULL,
	quantite int(4) NOT NULL,
	PRIMARY KEY (produit,facture)
);
ALTER TABLE LISTE_PRODUIT_FACTURE ADD FOREIGN KEY (produit) REFERENCES PRODUIT(idProduit);
ALTER TABLE LISTE_PRODUIT_FACTURE ADD FOREIGN KEY (facture) REFERENCES FACTURE(idFacture);

-- panier
ALTER TABLE PANIER RENAME TO LISTE_PROD UIT_PANIER;
ALTER TABLE LISTE_PRODUIT_PANIER CHANGE emailClient panier VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL;
ALTER TABLE LISTE_PRODUIT_PANIER CHANGE idProduit produit INT(4) NOT NULL;
ALTER TABLE LISTE_PRODUIT_PANIER CHANGE nbProduit quantite INT(4) NOT NULL;

CREATE TABLE PANIER (
	idPanier varchar(100) NOT NULL,
	prixHT FLOAT(4) NOT NULL DEFAULT '0',
	prixTTC FLOAT(4) NOT NULL DEFAULT '0',
	PRIMARY KEY (idPanier)
);
ALTER TABLE PANIER ADD FOREIGN KEY (idPanier) REFERENCES CLIENT(email);

INSERT INTO PANIER (idPanier, prixHT, prixTTC) VALUES ('admin@admin.com', '0', '0');
INSERT INTO PANIER (idPanier, prixHT, prixTTC) VALUES ('jean-yves.affin@gmail.com', '0', '0');