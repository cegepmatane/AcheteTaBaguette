...
ALTER TABLE FACTURE ADD emailClient varchar(100) NOT NULL AFTER idFacture, ADD prixHT FLOAT(4) NOT NULL DEFAULT '0' AFTER dateAchat, ADD prixTTC FLOAT(4) NOT NULL DEFAULT '0' AFTER prixHT;
