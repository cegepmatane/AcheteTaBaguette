...
ALTER TABLE LISTE_PRODUIT_FACTURE ADD FOREIGN KEY (idProduit) REFERENCES PRODUIT(idProduit);
ALTER TABLE LISTE_PRODUIT_FACTURE ADD FOREIGN KEY (idFacture) REFERENCES FACTURE(idFacture);
